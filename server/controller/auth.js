...
const register = async (req, res) => {
    try {
        ...
        const newUser = await pool.query('INSERT INTO users(user_name,user_email,user_password,user_number) VALUES($1,$2,$3,$4) RETURNING *',[user_name,user_email,bcryptPassword,user_number]);
...
const login = async (req, res) => {
    ...
    let user_id = await pool.query('SELECT user_id FROM users WHERE user_email = $1',[user_email]);
